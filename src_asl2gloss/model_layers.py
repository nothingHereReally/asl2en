...
#
#
# att_q_h1= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h1= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h1= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
# ))(x)
#
# att_q_h2= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h2= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h2= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
#
# att_q_h3= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h3= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h3= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
#
# att_q_h4= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h4= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h4= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
#
# att_q_h5= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h5= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h5= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
#
# att_q_h6= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h6= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h6= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
#
# att_q_h7= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h7= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h7= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
#
# att_q_h8= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_v_h8= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
# att_k_h8= TimeDistributed(TimeDistributed(Dense(
#     units=1,
#     activation=ReLU(negative_slope=0.0, max_value=256.0, threshold=0.0),
#     dtype=float64,
#     )))(x)
#
#
# att_h1= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h1, att_v_h1, att_k_h1])
# att_h2= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h2, att_v_h2, att_k_h2])
# att_h3= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h3, att_v_h3, att_k_h3])
# att_h4= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h4, att_v_h4, att_k_h4])
# att_h5= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h5, att_v_h5, att_k_h5])
# att_h6= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h6, att_v_h6, att_k_h6])
# att_h7= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h7, att_v_h7, att_k_h7])
# att_h8= TimeDistributed(Attention(
#     use_scale=True,
#     dropout=0.1,
#     dtype=float64,
#     ))([att_q_h8, att_v_h8, att_k_h8])
