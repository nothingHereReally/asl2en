# best model
# 1) model v67 (87.93% train/val/test GLASL g22, 8  images needed)
# 2) model v66 (86.19% train/val/test GLASL g22, 6  images needed)
# 3) model v41 (86.33% train/val/test GLASL g22, 22 images needed)
# 4) model v30 (83.8%  train/val/test GLASL g22, 22 images needed)
# 5) model v25 (87.06% train/val/test GLASL g10, 22 images needed)
# 6) model v23 (85.5%  train/val/test GLASL g10, 22 images needed)
# 7) model v22 (60% testing g10)
# 8) model v15 (57% testing g10)
# 9) model v14 (56% testing g10)
#10) model v12 (4% testing)
#11) model v10 (4% testing)
...
def main():
    ...
    model_file_name: str= "aslvid2gloss_v54.keras"
