...
from keras.src.layers import LSTM, Add, Attention, Concatenate, Flatten, Normalization, Reshape, Dense, Input, TimeDistributed
...
lstm= Add(
    name='add_lstm_concat'
)([lstm, conct])
lstm= Normalization(name='norm_2ndpart')(lstm) # shape (22, 64)
_, _, lstm= LSTM(
    units=16,
    return_state=True,
    name='lstm_be_short'
