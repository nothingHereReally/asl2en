...
LANDMARK_DIR: Path= DS_DIR /"fixed_landmark"
SKELETON_DIR: Path= DS_DIR /"fixed_skeleton"
IMG_SIZE: int= 158
KEY_G: str= 'gloss'
KEY_VIDS: str= 'videos'
...
def main() -> None:
    ...
    with open(f"{DS_DIR /'fixed_data.investigate.landmark.json'}", 'w') as f:
        writeJson(fixed_landmark_notation, f, indent=4)
    with open(f"{DS_DIR /'fixed_data.investigate.skeleton.json'}", 'w') as f:
